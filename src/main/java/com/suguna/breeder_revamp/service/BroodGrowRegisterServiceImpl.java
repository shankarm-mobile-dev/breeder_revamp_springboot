...
import com.suguna.breeder_revamp.dto.BroodGrowRegisterRequestDto;
...
public class BroodGrowRegisterServiceImpl implements BroodGrowRegisterService {
    ...
    @Override
    @Transactional
    public String getReport(BroodGrowRegisterRequestDto req) {
        ...
        try {
            ...
            query.registerStoredProcedureParameter("p_branch_id", Integer.class, ParameterMode.IN);
            ...
            query.setParameter("p_branch_id", req.getBranchId());
            ...
            query.setParameter("p_mode", req.getMode());
            ...
            throw new RuntimeException("Error executing Brooding & Growing Register report: " + e.getMessage());
        }
    }
}
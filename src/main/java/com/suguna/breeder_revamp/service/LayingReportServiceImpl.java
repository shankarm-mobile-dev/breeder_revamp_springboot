    ...
    public String getLayingReport(LayingReportRequestDto req) {
        ...
        try {
            ...
            StoredProcedureQuery query = entityManager.createStoredProcedureQuery(
                    "sug_rpt_gpps_pkg.sug_flk_lyreg_rpt");
            ...
            query.execute();
            String errbuf = (String) query.getOutputParameterValue("errbuf");
            Integer retcode = (Integer) query.getOutputParameterValue("retcode");
            ...
            throw new RuntimeException(
                    ...
                    "Error executing report: " + e.getMessage(), e);

...
public interface OtpRepositories extends JpaRepository<OTPsModel,Long> {
    ...
    OTPsModel findRecentOtp(@Param("userName") String userName, @Param("application") String application, @Param("otp") String otp, @Param("type") String type);
}
